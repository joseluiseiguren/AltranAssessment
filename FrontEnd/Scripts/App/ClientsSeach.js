...
var ClientsSearch = (function () {
    function ClientsSearch() {
        ...
        this.roleFilterValues.push(new CboInstallmentPayment(-1, '<Any>'));
        this.roleFilterValues.push(new CboInstallmentPayment(0, 'Admin'));
        this.roleFilterValues.push(new CboInstallmentPayment(1, 'Users'));
...
//# sourceMappingURL=ClientsSeach.js.map