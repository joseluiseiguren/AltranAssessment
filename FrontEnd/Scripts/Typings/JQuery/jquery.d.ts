...
interface JQueryStatic {
    ...
    // Custom Properties
    number(p1: any, p2: any, p3: any, p4: any): any;
    validator: any;
...
interface JQuery {
    ...
    */
    ...
    // Custom Properties
    datepicker(action: string): string;
    datepicker(obj: any): JQuery;
    datepicker(action: string, param: string): JQuery;
    datepicker(action: string, param: Date): JQuery;
    timepicker(obj: any): JQuery;
    number(p1: boolean, p2: number, p3: string, p4: string): JQuery;
    validate(): any;
    validate(p1: any): any;
    valid(): JQuery;
    sort: any;
